...
const resources = {
  "zh-CN": {
    translation: {
      ...
      poolkeeper: {
        title: "补号设置",
        description: "管理 Grok2API 池测活、清号与 8787 水位补号策略。设置经管理端 API 代理到本机 Poolkeeper。",
        saved: "补号设置已保存",
        runOnce: "立即跑一轮",
        runStarted: "已启动一轮维护任务",
        unavailable: "补号服务不可用，请确认 Poolkeeper 已在 :9109 运行",
        statusMode: "当前模式",
        dryRunMode: "干跑观察",
        liveMode: "实动模式",
        running: "任务运行中",
        g2a: "Grok2API",
        register: "8787 注册台",
        publicRegister: "8787 公网",
        lastRun: "最近一轮结果",
        fields: {
          dryRun: "干跑 dry_run",
          dryRunHelp: "开启时只统计，不禁用/删除/注册。",
          replenishEnabled: "启用自动补号",
          replenishEnabledHelp: "可用号低于低水位时触发库存推送或 8787 注册。",
          low: "低水位",
          target: "目标水位",
          emergency: "紧急水位",
          interval: "调度间隔（分钟）",
          ...
          maxClean: "每轮最多清号",
          maxRegister: "每轮最多注册",
          inventoryFirst: "优先本地库存",
          pauseWhenActive: "有注册任务时暂停",
        },
      },
      creativeConsole: {
        title: "创作控制台",
  ...
  en: {
    translation: {
      ...
      nav: { dashboard: "Dashboard", accounts: "Accounts", poolkeeper: "Replenish", models: "Models", clientKeys: "Client keys", creativeConsole: "Creative console", gallery: "Gallery", videoGallery: "Video Gallery", audits: "Request audits", docs: "Documentation", settings: "Settings" },
      poolkeeper: {
        title: "Replenish settings",
        description: "Configure Grok2API pool probing, dead-account cleanup, and 8787 waterline replenishment. Settings are proxied through the admin API to local Poolkeeper.",
        saved: "Replenish settings saved",
        runOnce: "Run once",
        runStarted: "Maintenance round started",
        unavailable: "Poolkeeper is unavailable. Ensure it is running on :9109.",
        statusMode: "Mode",
        dryRunMode: "Dry-run",
        liveMode: "Live",
        running: "Running",
        g2a: "Grok2API",
        register: "Register (8787)",
        publicRegister: "Public 8787",
        lastRun: "Last run",
        fields: {
          dryRun: "Dry-run",
          dryRunHelp: "When on, only observe — no disable/delete/register.",
          replenishEnabled: "Enable replenish",
          replenishEnabledHelp: "When healthy accounts fall below the low waterline, push inventory or register via 8787.",
          low: "Low waterline",
          target: "Target waterline",
          emergency: "Emergency waterline",
          interval: "Interval (minutes)",
          maxProbe: "Max probes / round",
          concurrency: "Probe concurrency",
          timeout: "Probe timeout (sec)",
          cleanupMode: "Cleanup mode",
          maxClean: "Max cleanup / round",
          maxRegister: "Max register / round",
          inventoryFirst: "Prefer local inventory",
          pauseWhenActive: "Pause if register job active",
        },
      },
      creativeConsole: {
