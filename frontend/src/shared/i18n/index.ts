...
const resources = {
  "zh-CN": {
    translation: {
      ...
      poolkeeper: {
        title: "补号设置",
        description: "池内测活、清死号、按水位自动补号（8787）。",
        saved: "已保存",
        runOnce: "立即跑一轮",
        runStarted: "已启动",
        unavailable: "补号服务不可用（需 :9109 Poolkeeper）",
        dryRunMode: "干跑",
        liveMode: "实动",
        running: "运行中",
        lastRun: "最近一轮",
        fields: {
          dryRun: "仅观察（干跑）",
          dryRunHelp: "打开时不禁用、不注册，只统计。",
          replenishEnabled: "自动补号",
          replenishEnabledHelp: "可用号低于低水位时走 8787 补号。",
          cleanupEnabled: "自动清死号",
          cleanupEnabledHelp: "确认死亡后禁用账号（不硬删）。",
          demotionEnabled: "失败降权",
          demotionEnabledHelp: "坏号先降 priority（soft/hard），冷却后 half-open 试探恢复。",
          low: "低水位",
          lowHelp: "可用号低于此值开始补。",
          target: "目标水位",
          targetHelp: "补到大约这个数量。",
          maxRegister: "单轮最多注册",
          maxRegisterHelp: "防止一次注册过多。",
          interval: "检查间隔（分钟）",
          intervalHelp: "定时维护的间隔。",
        },
      },
      creativeConsole: {
        title: "创作控制台",
  ...
  en: {
    translation: {
      ...
      poolkeeper: {
        title: "Replenish",
        description: "Probe the pool, disable dead accounts, replenish via 8787 by waterline.",
        saved: "Saved",
        runOnce: "Run once",
        runStarted: "Started",
        unavailable: "Poolkeeper unavailable (:9109)",
        dryRunMode: "Dry-run",
        liveMode: "Live",
        running: "Running",
        lastRun: "Last run",
        fields: {
          dryRun: "Dry-run only",
          dryRunHelp: "Observe only — no disable or register.",
          replenishEnabled: "Auto replenish",
          replenishEnabledHelp: "Register via 8787 when below low waterline.",
          cleanupEnabled: "Disable dead accounts",
          cleanupEnabledHelp: "Disable confirmed-dead accounts (no hard delete).",
          demotionEnabled: "Failure demotion",
          demotionEnabledHelp: "Lower priority on bad accounts (soft/hard), then half-open recovery.",
          low: "Low waterline",
          lowHelp: "Start replenish below this count.",
          target: "Target waterline",
          targetHelp: "Aim for about this many healthy accounts.",
          maxRegister: "Max register / round",
          maxRegisterHelp: "Cap how many to register each round.",
          interval: "Interval (minutes)",
          intervalHelp: "How often maintenance runs.",
        },
      },
      creativeConsole: {
