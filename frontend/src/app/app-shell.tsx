...
import { Box, ChevronDown, Eye, Image, KeyRound, Languages, LayoutDashboard, LogOut, Menu, MessageSquareText, Monitor, Moon, MoreHorizontal, RefreshCw, Settings, Sparkles, Sun, Users, Video } from "lucide-react";
...
const navigation = [
  ...
  { href: "/poolkeeper", label: "nav.poolkeeper", icon: RefreshCw },
